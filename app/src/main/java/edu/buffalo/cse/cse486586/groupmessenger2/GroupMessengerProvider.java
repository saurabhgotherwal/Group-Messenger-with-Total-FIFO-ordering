...
public class GroupMessengerProvider extends ContentProvider {
    ...
    private void WriteMessageIntoInternalStorage(String filename, String content){
        ...
        /*
        References for writing lines 71-80:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        String value = ReadMessageFromInternalStorage(selection);
        ...
        /*
        References for writing lines 113-119:
    ...
    private String ReadMessageFromInternalStorage(String key){
        ...
        /*
        References for writing lines 133-145:
